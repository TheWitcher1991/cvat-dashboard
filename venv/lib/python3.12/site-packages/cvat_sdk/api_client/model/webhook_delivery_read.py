...
class IWebhookDeliveryRead(IModelData):
    ...
    request: typing.Union[typing.Any, none_type] # noqa: E501
    """
    [optional]
    """

    response: typing.Union[typing.Any, none_type] # noqa: E501
    """
    [optional]
    """
...
class WebhookDeliveryRead(ModelNormal, IWebhookDeliveryRead):
    ...
    Attributes:
      ...
      response (bool, date, datetime, dict, float, int, list, str, none_type): [optional]  # noqa: E501
